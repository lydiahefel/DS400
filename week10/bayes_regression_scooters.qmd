...
```{r}
ggplot(bikes_scooters, aes(x = temp_actual , y = rides, color = as.factor(year))) +
  geom_point() +
  facet_wrap(~season) #+
...
```{r}
ggplot(bikes_scooters, aes(x = temp_actual , y = scooter_rides, color = as.factor(year))) +
  geom_point() +
  facet_wrap(~season)
```

```{r}
ggplot(bikes_scooters, aes(x = temp_actual , y = scooter_rides)) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor()
```
...
```{r}
ggplot(bikes_scooters, aes(x = temp_actual , y = rides)) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor()
```
...
```{r}
ggplot(bikes_scooters, aes(x = temp_actual , y = scooter_rides, color = season, shape = holiday)) +
  geom_point()
```

```{r}
ggplot(bikes_scooters, aes(x = temp_actual , y = rides, color = season, shape = holiday)) +
  geom_point() 
```

```{r}
avg_scooters_rides_by_day <- bikes_scooters %>% 
  group_by(day_of_week) %>% 
  summarise(mean_rides = mean(scooter_rides, na.rm = TRUE))

ggplot(avg_scooters_rides_by_day, aes(x= day_of_week, y = mean_rides)) +
